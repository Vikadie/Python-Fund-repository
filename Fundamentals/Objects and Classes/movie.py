class Movie:
    ...
    def __repr__(self):
        self.total_watched_movies = self.__watched_movies
        return f"Movie name: {self.name}; Movie director: {self.director}. Total watched movies: {self.total_watched_movies}"
